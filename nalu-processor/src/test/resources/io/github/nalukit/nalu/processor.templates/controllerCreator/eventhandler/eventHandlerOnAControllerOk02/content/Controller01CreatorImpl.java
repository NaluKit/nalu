package io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk02.content;
...
public final class Controller01CreatorImpl extends AbstractControllerCreator<MockContext> implements IsControllerCreator {
  ...
  public ControllerInstance create(String route) {
    ...
    controllerInstance.setControllerClassName("io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk02.content.Controller01");
    AbstractComponentController<?, ?, ?> storedController = ControllerFactory.INSTANCE.getControllerFormStore("io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk02.content.Controller01");
    if (storedController == null) {
      ...
      controller.setActivateNaluCommand(() -> {
        ...
        controller.getHandlerRegistrations().add(this.eventBus.addHandler(io.github.nalukit.nalu.processor.common.event.MockEvent02.TYPE, e -> controller.onMockEvent02(e)));
      });
    } else {
