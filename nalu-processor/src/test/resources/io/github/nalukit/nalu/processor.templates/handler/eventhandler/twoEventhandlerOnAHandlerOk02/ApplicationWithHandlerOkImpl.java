...
public final class ApplicationWithHandlerOkImpl extends AbstractApplication<MockContext> implements ApplicationWithHandlerOk {
  ...
  public void loadHandlers() {
    TwoEventHandlerOnAHandlerOk io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk02_TwoEventHandlerOnAHandlerOk = new TwoEventHandlerOnAHandlerOk();
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk02_TwoEventHandlerOnAHandlerOk.setContext(super.context);
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk02_TwoEventHandlerOnAHandlerOk.setEventBus(super.eventBus);
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk02_TwoEventHandlerOnAHandlerOk.setRouter(super.router);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk02_TwoEventHandlerOnAHandlerOk.onMockEvent0101(e));
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk02_TwoEventHandlerOnAHandlerOk.onMockEvent0102(e));
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk02_TwoEventHandlerOnAHandlerOk.bind();
  }
