package io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02;
...
import io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.error.ErrorComponent;
import io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.error.ErrorController;
import io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.error.IErrorComponent;
import java.lang.Override;

import java.util.Arrays;

/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at >>2022.04.20-11:49:31<<
 */
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadShells() {
    super.shellConfiguration.getShells().add(new ShellConfig("/mockShell01", "io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.MockShell01"));
  }

  @Override
  public void loadShellFactory() {
    ShellFactory.INSTANCE.registerShell("io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.MockShell01",
                                        new io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.MockShell01CreatorImpl(router,
                                                                                                                                                               context,
                                                                                                                                                               eventBus));
  }
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.content.Controller01",
                                                  new io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.content.Controller01CreatorImpl(router,
                                                                                                                                                                                  context,
                                                                                                                                                                                  eventBus));
  }
  ...
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell01/route01", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.content.Controller01"));
  }
