package io.github.nalukit.nalu.processor.controllerCreator.controllerCreatorOkWithoutParameter;
...
public final class ControllerC01CreatorImpl extends AbstractControllerCreator<MockContext> implements IsControllerCreator {
  public ControllerC01CreatorImpl(IsRouter router, MockContext context, SimpleEventBus eventBus) {
  ...
  public ControllerInstance create(String route) {
    ...
    controllerInstance.setControllerClassName("io.github.nalukit.nalu.processor.controllerCreator.controllerCreatorOkWithoutParameter.ControllerC01");
    AbstractComponentController<?, ?, ?> storedController = ControllerFactory.INSTANCE.getControllerFormStore("io.github.nalukit.nalu.processor.controllerCreator.controllerCreatorOkWithoutParameter.ControllerC01");
