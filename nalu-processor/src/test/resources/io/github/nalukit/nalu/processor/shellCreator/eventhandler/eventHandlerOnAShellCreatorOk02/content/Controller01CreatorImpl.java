package io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.content;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at >>2022.04.20-11:43:58<<
 */
public final class Controller01CreatorImpl extends AbstractControllerCreator<MockContext> implements IsControllerCreator {
  ...
  public ControllerInstance create(String route) {
    ...
    controllerInstance.setControllerClassName("io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.content.Controller01");
    AbstractComponentController<?, ?, ?> storedController = ControllerFactory.INSTANCE.getControllerFormStore("io.github.nalukit.nalu.processor.shellCreator.eventhandler.eventHandlerOnAShellCreatorOk02.content.Controller01");
