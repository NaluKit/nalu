package io.github.nalukit.nalu.processor.parameterConstraintRule.whiteList;
...
/**
 * Build with Nalu version >>%VERSION_TAG%<< at >>2021.07.30-14:54:55<<
 */
public final class ParameterConstraintWhiteListImpl extends AbstractParameterConstraintRule implements IsParameterConstraintRule {
  ...
  @Override
  public String key() {
    return "io.github.nalukit.nalu.processor.parameterConstraintRule.whiteList.ParameterConstraintWhiteList";
  }
