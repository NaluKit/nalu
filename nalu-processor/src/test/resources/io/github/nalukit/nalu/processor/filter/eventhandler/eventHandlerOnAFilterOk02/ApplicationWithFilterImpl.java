package io.github.nalukit.nalu.processor.filter.eventhandler.eventHandlerOnAFilterOk02;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at 2023.01.30-22:01:11
 */
public final class ApplicationWithFilterImpl extends AbstractApplication<MockContext> implements ApplicationWithFilter {
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.common.ui.component01.Controller01", new io.github.nalukit.nalu.processor.common.ui.component01.Controller01CreatorImpl(router, context, eventBus));
  }
  ...
  public void loadFilters() {
    MockFilter io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk02_MockFilter = new MockFilter();
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk02_MockFilter.setContext(super.context);
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk02_MockFilter.setEventBus(super.eventBus);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk02_MockFilter.handleEvent(e));
    super.eventBus.addHandler(MockEvent02.TYPE, e -> io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk02_MockFilter.handleEvent02(e));
    super.routerConfiguration.getFilters().add(io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk02_MockFilter);
  }
