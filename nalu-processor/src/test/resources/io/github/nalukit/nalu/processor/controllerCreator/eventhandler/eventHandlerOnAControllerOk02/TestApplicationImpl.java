package io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk02;
...
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk02.content.Controller01",
                                                  new io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk02.content.Controller01CreatorImpl(router,
                                                                                                                                                                                     context,
                                                                                                                                                                                     eventBus));
  }
  ...
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route01", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk02.content.Controller01"));
  }
