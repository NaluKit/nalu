package io.github.nalukit.nalu.processor.filter.eventhandler.eventHandlerOnAFilterOk01;
...
public final class ApplicationWithFilterImpl extends AbstractApplication<MockContext> implements ApplicationWithFilter {
  ...
  public void loadFilters() {
    MockFilter io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter = new MockFilter();
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter.setContext(super.context);
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter.setEventBus(super.eventBus);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter.handleEvent(e));
    super.routerConfiguration.getFilters().add(io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter);
  }
