...
public final class ApplicationWithHandlerOkImpl extends AbstractApplication<MockContext> implements ApplicationWithHandlerOk {
  ...
  public void loadHandlers() {
    TwoEventHandlerOnAHandlerOk io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk_TwoEventHandlerOnAHandlerOk = new TwoEventHandlerOnAHandlerOk();
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk_TwoEventHandlerOnAHandlerOk.setContext(super.context);
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk_TwoEventHandlerOnAHandlerOk.setEventBus(super.eventBus);
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk_TwoEventHandlerOnAHandlerOk.setRouter(super.router);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk_TwoEventHandlerOnAHandlerOk.onMockEvent01(e));
    super.eventBus.addHandler(MockEvent02.TYPE, e -> io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk_TwoEventHandlerOnAHandlerOk.onMockEvent02(e));
    io_github_nalukit_nalu_processor_handler_eventhandler_twoEventhandlerOnAHandlerOk_TwoEventHandlerOnAHandlerOk.bind();
  }
