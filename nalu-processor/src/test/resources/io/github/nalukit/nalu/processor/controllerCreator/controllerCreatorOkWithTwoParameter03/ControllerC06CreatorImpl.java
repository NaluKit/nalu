package io.github.nalukit.nalu.processor.controllerCreator.controllerCreatorOkWithTwoParameter03;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at 2023.03.03-18:04:46
 */
public final class ControllerC06CreatorImpl extends AbstractControllerCreator<MockContext> implements IsControllerCreator {
  ...
  public ControllerInstance create(String route) {
    ...
    controllerInstance.setControllerClassName("io.github.nalukit.nalu.processor.controllerCreator.controllerCreatorOkWithTwoParameter03.ControllerC06");
    AbstractComponentController<?, ?, ?> storedController = ControllerFactory.INSTANCE.getControllerFormStore("io.github.nalukit.nalu.processor.controllerCreator.controllerCreatorOkWithTwoParameter03.ControllerC06");
