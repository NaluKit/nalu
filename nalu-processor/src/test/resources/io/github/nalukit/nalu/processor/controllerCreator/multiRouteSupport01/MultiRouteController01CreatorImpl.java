package io.github.nalukit.nalu.processor.controllerCreator.multiRouteSupport01;
...
public final class MultiRouteController01CreatorImpl extends AbstractControllerCreator<MockContext> implements IsControllerCreator {
  ...
  public ControllerInstance create(String route) {
    ...
    controllerInstance.setControllerClassName("io.github.nalukit.nalu.processor.controllerCreator.multiRouteSupport01.MultiRouteController01");
    AbstractComponentController<?, ?, ?> storedController = ControllerFactory.INSTANCE.getControllerFormStore("io.github.nalukit.nalu.processor.controllerCreator.multiRouteSupport01.MultiRouteController01");
