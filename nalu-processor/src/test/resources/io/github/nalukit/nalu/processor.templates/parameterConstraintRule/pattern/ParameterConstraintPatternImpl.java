package io.github.nalukit.nalu.processor.parameterConstraintRule.pattern;
...
public final class ParameterConstraintPatternImpl extends AbstractParameterConstraintRule implements IsParameterConstraintRule {
  ...
  @Override
  public String key() {
    return "io.github.nalukit.nalu.processor.parameterConstraintRule.pattern.ParameterConstraintPattern";
  }
