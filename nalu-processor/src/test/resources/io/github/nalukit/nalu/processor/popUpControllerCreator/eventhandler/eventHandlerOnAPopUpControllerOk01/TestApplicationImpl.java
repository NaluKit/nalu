package io.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at >>2022.04.19-16:59:36<<
 */
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01.content.Controller01",
                                                  new io.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01.content.Controller01CreatorImpl(router,
                                                                                                                                                                                               context,
                                                                                                                                                                                               eventBus));
  }
  ...
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route01", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01.content.Controller01"));
  }
  ...
  public void loadPopUpControllerFactory() {
    PopUpControllerFactory.INSTANCE.registerPopUpController("PopUpController01",
                                                            new io.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01.popUp.PopUpController01CreatorImpl(router,
                                                                                                                                                                                                            context,
                                                                                                                                                                                                            eventBus));
