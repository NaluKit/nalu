package io.github.nalukit.nalu.processor.filter.eventhandler.eventHandlerOnTwoFiltersOk01;
...
public final class ApplicationWithFilterImpl extends AbstractApplication<MockContext> implements ApplicationWithFilter {
  ...
  public void loadFilters() {
    MockFilter io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter = new MockFilter();
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter.setContext(super.context);
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter.setEventBus(super.eventBus);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter.handleEvent(e));
    super.routerConfiguration.getFilters().add(io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter);
    MockFilter02 io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter02 = new MockFilter02();
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter02.setContext(super.context);
    io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter02.setEventBus(super.eventBus);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter02.handleEvent(e));
    super.routerConfiguration.getFilters().add(io_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnTwoFiltersOk01_MockFilter02);
  }
