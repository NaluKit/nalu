package io.github.nalukit.nalu.processor.eventhandler.ignoreEventHandler;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at >>2022.04.20-22:08:48<<
 */
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.eventHandler.ignoreEventHandler.content01.Content01Controller",
                                                  new io.github.nalukit.nalu.processor.eventHandler.ignoreEventHandler.content01.Content01ControllerCreatorImpl(router,
                                                                                                                                                                 context,
                                                                                                                                                                 eventBus));
  }
  ...
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route01", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.eventHandler.ignoreEventHandler.content01.Content01Controller"));
  }
