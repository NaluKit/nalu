package io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at >>2022.04.18-15:37:25<<
 */
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller01",
                                                  new io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller01CreatorImpl(router,
                                                                                                                                                                                     context,
                                                                                                                                                                                     eventBus));
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller02",
                                                  new io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller02CreatorImpl(router,
                                                                                                                                                                                     context,
                                                                                                                                                                                     eventBus));
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller03",
                                                  new io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller03CreatorImpl(router,
                                                                                                                                                                                     context,
                                                                                                                                                                                     eventBus));
  }
  ...
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route01", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller01"));
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route02", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller02"));
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route03", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.controllerCreator.eventhandler.eventHandlerOnAControllerOk03.content.Controller03"));
  }
