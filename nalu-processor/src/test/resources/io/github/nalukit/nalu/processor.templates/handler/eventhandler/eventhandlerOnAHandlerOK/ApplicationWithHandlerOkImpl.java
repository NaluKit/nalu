package io.github.nalukit.nalu.processor.handler.eventhandler.eventhandlerOnAHandlerOK;
...
public final class ApplicationWithHandlerOkImpl extends AbstractApplication<MockContext> implements ApplicationWithHandlerOk {
  ...
  public void loadHandlers() {
    EventHandlerOnAHandlerOk io_github_nalukit_nalu_processor_eventhandler_handler_eventhandlerOnAHandlerOK_EventHandlerOnAHandlerOk = new EventHandlerOnAHandlerOk();
    io_github_nalukit_nalu_processor_eventhandler_handler_eventhandlerOnAHandlerOK_EventHandlerOnAHandlerOk.setContext(super.context);
    io_github_nalukit_nalu_processor_eventhandler_handler_eventhandlerOnAHandlerOK_EventHandlerOnAHandlerOk.setEventBus(super.eventBus);
    io_github_nalukit_nalu_processor_eventhandler_handler_eventhandlerOnAHandlerOK_EventHandlerOnAHandlerOk.setRouter(super.router);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> io_github_nalukit_nalu_processor_eventhandler_handler_eventhandlerOnAHandlerOK_EventHandlerOnAHandlerOk.onMockEvent01(e));
    io_github_nalukit_nalu_processor_eventhandler_handler_eventhandlerOnAHandlerOK_EventHandlerOnAHandlerOk.bind();
  }
