package io.github.nalukit.nalu.processor.controller.generateWithIsComponentCreator;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at >>2020.11.18-06:49:48<<
 */
public final class GenerateWithIsComponentCreatorImpl extends AbstractApplication<MockContext> implements GenerateWithIsComponentCreator {
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("io.github.nalukit.nalu.processor.controller.generateWithIsComponentCreator.ui.content01.Content01Controller",
                                                  new io.github.nalukit.nalu.processor.controller.generateWithIsComponentCreator.ui.content01.Content01ControllerCreatorImpl(router,
                                                                                                                                                                              context,
                                                                                                                                                                              eventBus));
  }
  ...
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route01", Arrays.asList(new String[]{}), "selector01", "io.github.nalukit.nalu.processor.controller.generateWithIsComponentCreator.ui.content01.Content01Controller"));
  }
