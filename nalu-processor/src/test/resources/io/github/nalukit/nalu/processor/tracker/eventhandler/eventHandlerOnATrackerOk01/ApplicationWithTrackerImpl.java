package io.github.nalukit.nalu.processor.tracker.eventhandler.eventHandlerOnATrackerOk01;
...
/**
 * Build with Nalu version >>HEAD-SNAPSHOT<< at >>2022.10.10-12:28:10<<
 */
public final class ApplicationWithTrackerImpl extends AbstractApplication<MockContext> implements ApplicationWithTracker {
  ...
  public IsTracker loadTrackerConfiguration() {
    MockTrackerWithEventHandler tracker = new MockTrackerWithEventHandler();
    tracker.setContext(super.context);
    tracker.setEventBus(super.eventBus);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> tracker.handleEvent(e));
    tracker.bind();
    return tracker;
  }
