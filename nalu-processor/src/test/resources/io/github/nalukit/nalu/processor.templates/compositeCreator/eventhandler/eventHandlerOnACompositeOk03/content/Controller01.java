...
package io.github.nalukit.nalu.processor.compositeCreator.eventhandler.eventHandlerOnACompositeOk03.content;
...
import io.github.nalukit.nalu.processor.compositeCreator.eventhandler.eventHandlerOnACompositeOk03.content.composite.Composite01;
import io.github.nalukit.nalu.processor.compositeCreator.eventhandler.eventHandlerOnACompositeOk03.content.composite.Composite02;
import io.github.nalukit.nalu.processor.compositeCreator.eventhandler.eventHandlerOnACompositeOk03.content.composite.Composite03;
...
@Composites({
    @Composite(name = "composite01",
               compositeController = Composite01.class,
               selector = "composite01"),
    @Composite(name = "composite02",
               compositeController = Composite02.class,
               selector = "composite02"),
    @Composite(name = "composite03",
               compositeController = Composite03.class,
               selector = "composite03")
})
public class Controller01
    extends AbstractComponentController<MockContext, IComponent01, HTMLElement>
