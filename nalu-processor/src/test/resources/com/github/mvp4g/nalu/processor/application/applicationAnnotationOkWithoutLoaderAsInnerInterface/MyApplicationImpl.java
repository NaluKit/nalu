...
import com.github.mvp4g.nalu.processor.application.applicationAnnotationOkWithoutLoaderAsInnerInterface.ApplicationAnnotationOkWithoutLoaderAsInnerInterface.MyApplication;
...
public final class MyApplicationImpl extends AbstractApplication<MockContext> implements MyApplication {
  ...
  public void loadDebugConfiguration() {
    ClientLogger.get().register(false, new DefaultLogger(), Debug.LogLevel.SIMPLE);
  }

  @Override
  public void loadSelectors() {
    super.routerConfiguration.getSelectors().put("content", "com.github.mvp4g.nalu.processor.common.MockShell");
    super.routerConfiguration.getSelectors().put("footer", "com.github.mvp4g.nalu.processor.common.MockShell");
    super.routerConfiguration.getSelectors().put("header", "com.github.mvp4g.nalu.processor.common.MockShell");
    super.routerConfiguration.getSelectors().put("navigation", "com.github.mvp4g.nalu.processor.common.MockShell");
  }
