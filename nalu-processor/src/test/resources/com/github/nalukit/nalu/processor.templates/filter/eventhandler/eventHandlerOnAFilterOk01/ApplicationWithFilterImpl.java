package com.github.nalukit.nalu.processor.filter.eventhandler.eventHandlerOnAFilterOk01;
...
public final class ApplicationWithFilterImpl extends AbstractApplication<MockContext> implements ApplicationWithFilter {
  ...
  public void logProcessorVersion() {
    this.eventBus.fireEvent(LogEvent.create().sdmOnly(true).addMessage("=================================================================================").addMessage("Nalu processor version  >>2.10.0<< used to generate this source").addMessage("=================================================================================").addMessage(""));
  }
  ...
  public void loadFilters() {
    MockFilter com_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter = new MockFilter();
    com_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter.setContext(super.context);
    com_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter.setEventBus(super.eventBus);
    super.eventBus.addHandler(MockEvent01.TYPE, e -> com_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter.handleEvent(e));
    super.routerConfiguration.getFilters().add(com_github_nalukit_nalu_processor_filter_eventhandler_eventHandlerOnAFilterOk01_MockFilter);
  }
