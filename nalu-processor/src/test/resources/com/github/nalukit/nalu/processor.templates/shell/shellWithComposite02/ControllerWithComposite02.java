...
import com.github.nalukit.nalu.processor.shell.shellWithComposite02.composite.CompositeController02;
...
@Composites(@Composite(name = "testComposite",
                       ...
                       selector = "selector",
                       condition = Composite02Condition.class))
public class ControllerWithComposite02
    extends AbstractComponentController<MockContext, IComponent02, HTMLElement>
