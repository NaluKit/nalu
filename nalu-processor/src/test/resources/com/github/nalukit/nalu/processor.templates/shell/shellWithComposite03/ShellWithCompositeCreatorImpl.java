...
/**
 * Build with Nalu version >>2.11.0<< at >>2032.10.11-12:34:18<<
 */
public final class ShellWithCompositeCreatorImpl extends AbstractShellCreator<MockContext> implements IsShellCreator {
  ...
  public ShellInstance create() {
    ...
    shellInstance.setShellClassName("com.github.nalukit.nalu.processor.shell.shellWithComposite03.ShellWithComposite");
