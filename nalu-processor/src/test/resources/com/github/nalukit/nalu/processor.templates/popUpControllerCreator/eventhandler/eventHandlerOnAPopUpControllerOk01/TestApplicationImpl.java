...
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.get().registerController("com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01.content.Controller01", new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01.content.Controller01CreatorImpl(router, context, eventBus));
  }
  ...
  public void loadPopUpControllerFactory() {
    PopUpControllerFactory.get().registerPopUpController("PopUpController01", new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk01.popUp.PopUpController01CreatorImpl(router, context, eventBus));
