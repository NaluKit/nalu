...
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.INSTANCE.registerController("com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.content.Controller01",
                                                  new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.content.Controller01CreatorImpl(router,
                                                                                                                                                                                               context,
                                                                                                                                                                                               eventBus));
  }
  ...
  public void loadPopUpControllerFactory() {
    PopUpControllerFactory.INSTANCE.registerPopUpController("PopUpController01",
                                                            new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.popUp.PopUpController01CreatorImpl(router,
                                                                                                                                                                                                            context,
                                                                                                                                                                                                            eventBus));
    ...
    PopUpControllerFactory.INSTANCE.registerPopUpController("PopUpController02",
                                                            new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.popUp.PopUpController02CreatorImpl(router,
                                                                                                                                                                                                            context,
                                                                                                                                                                                                            eventBus));
    ...
    PopUpControllerFactory.INSTANCE.registerPopUpController("PopUpController03",
                                                            new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.popUp.PopUpController03CreatorImpl(router,
                                                                                                                                                                                                            context,
                                                                                                                                                                                                            eventBus));
