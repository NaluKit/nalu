...
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.get().registerController("com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.content.Controller01", new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.content.Controller01CreatorImpl(router, context, eventBus));
  }

  @Override
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route01", Arrays.asList(new String[]{}), "selector01", "com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.content.Controller01"));
  }
  ...
  public void loadPopUpControllerFactory() {
    PopUpControllerFactory.get().registerPopUpController("PopUpController01", new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.popUp.PopUpController01CreatorImpl(router, context, eventBus));
    PopUpConditionFactory.get().registerCondition("PopUpController01",  super.alwaysShowPopUp);
    PopUpControllerFactory.get().registerPopUpController("PopUpController02", new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.popUp.PopUpController02CreatorImpl(router, context, eventBus));
    PopUpConditionFactory.get().registerCondition("PopUpController02",  super.alwaysShowPopUp);
    PopUpControllerFactory.get().registerPopUpController("PopUpController03", new com.github.nalukit.nalu.processor.popUpControllerCreator.eventhandler.eventHandlerOnAPopUpControllerOk03.popUp.PopUpController03CreatorImpl(router, context, eventBus));
    PopUpConditionFactory.get().registerCondition("PopUpController03",  super.alwaysShowPopUp);
  }
