package com.github.nalukit.nalu.processor.eventhandler.ignoreEventHandler;
...
public final class TestApplicationImpl extends AbstractApplication<MockContext> implements TestApplication {
  ...
  public void loadComponents() {
    ControllerFactory.get().registerController("com.github.nalukit.nalu.processor.eventHandler.ignoreEventHandler.content01.Content01Controller", new com.github.nalukit.nalu.processor.eventHandler.ignoreEventHandler.content01.Content01ControllerCreatorImpl(router, context, eventBus));
  }

  @Override
  public void loadRoutes() {
    super.routerConfiguration.getRouters().add(new RouteConfig("/mockShell/route01", Arrays.asList(new String[]{}), "selector01", "com.github.nalukit.nalu.processor.eventHandler.ignoreEventHandler.content01.Content01Controller"));
  }
