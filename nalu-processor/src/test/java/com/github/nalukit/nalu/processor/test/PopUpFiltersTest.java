...
public class PopUpFiltersTest {
  ...
  void testFiltersAnnotationOnAMethod() {
    Compilation compilation = javac().withProcessors(new NaluProcessor())
                                     .compile(Collections.singletonList(JavaFileObjects.forResource("com/github/nalukit/nalu/processor/popupfilter/popupfilterAnnotationOnAMethod/PopUpFilterAnnotationOnAMethod.java")));
