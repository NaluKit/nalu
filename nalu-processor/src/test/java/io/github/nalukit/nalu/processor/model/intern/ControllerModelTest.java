  ...
  private ControllerModel getControllerModelForMatchingTest(String route,
    ...
    return new ControllerModel(new String[] { route },
                               ...
                               Arrays.asList("parameter01",
                                             "parameter02"),
                               new ClassNameModel("io.github.nalukit.nalu.processor.common.ui.component01,Controller01"),
                               new ClassNameModel("io.github.nalukit.nalu.processor.common.ui.component01,IComponent01"),
                               new ClassNameModel("io.github.nalukit.nalu.processor.common.ui.component01,Component01"),
                               new ClassNameModel("io.github.nalukit.nalu.processor.common.ui.component01,Component01"),
                               new ClassNameModel("io.github.nalukit.nalu.processor.common.ui.component01,Component01"),
                               false);
