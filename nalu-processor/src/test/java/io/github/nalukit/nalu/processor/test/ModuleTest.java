...
public class ModuleTest {
  ...
  void testSubModuleHasErrorPopUpController() {
    Compilation compilation = javac().withProcessors(new NaluProcessor())
                                     .compile(Arrays.asList(JavaFileObjects.forResource("io/github/nalukit/nalu/processor/module/subModuleHasErrorPopUpController/MockSubModule.java"),
                                                            JavaFileObjects.forResource("io/github/nalukit/nalu/processor/common/module/MockSubModuleContext.java"),
