...
public class RoutesAnnotationValidator {
  ...
  private RoutesAnnotationValidator() {
  }

  private RoutesAnnotationValidator(Builder builder) {
  ...
  public void validate()
    ...
    if (!typeElement.getKind()
                    .isClass()) {
      throw new ProcessorException("Nalu-Processor: @Routes can only be used with an class");
    }
    ...
    if (!(this.processorUtils.extendsClassOrInterface(this.processingEnvironment.getTypeUtils(),
      ...
      throw new ProcessorException("Nalu-Processor: @Routes can only be used on a class that extends IsController or IsShell");
    }
  ...
  public static final class Builder {
    ...
    public RoutesAnnotationValidator build() {
      return new RoutesAnnotationValidator(this);
    }
  }
}
