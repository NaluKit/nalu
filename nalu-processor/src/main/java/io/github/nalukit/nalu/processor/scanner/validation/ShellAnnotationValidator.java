...
public class ShellAnnotationValidator {
  ...
  private String getContextType(Element element)
    ...
    try {
      ...
      throw new ProcessorException("Nalu-Processor: shellCreator >>io.github.nalukit.nalu.processor.shellCreator.shellDoesNotHaveGenericContext.ShellDoesNotHaveGenericContext<< does not have a context generic!");
    }
  }
