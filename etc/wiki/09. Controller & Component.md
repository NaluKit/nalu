...
In order to use composite controllers in Nalu, you have to add the `Composite` annotation to a controller. THe `Composites` annotion will have another `Composite` annotation for each composite.
