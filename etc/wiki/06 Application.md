...
It is possible to override the value from the version annotation from the command line. Nalu will look for a property called "nalu.application.version". If the property exists, Nalu will use this value. This will only work, if the Version annotation is used.


## Debug Annotation (removed in version v2.1.0) # Application
Every Nalu application needs one application interface. The application interface defines the basic behavoir of Nalu.
