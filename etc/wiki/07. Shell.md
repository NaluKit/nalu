...
The shell is the root view of the application. It devides the screen in several areas, which can be used to add components. A Nalu application supports more then one shell. TO define which shell should currently be used, add the name of the shell as first part of the route.
