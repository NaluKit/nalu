...
### Note
This implementation might look a little bit boiler-plated, but it helps you to avoid a common project where all modules and the main module depend on! # Multi Module Envirement
There are several reasons to divide an application into several modules. Reasons might be:
