...
public interface IsNaluCorePlugin {

  void getContextPath(ShellConfiguration shellConfiguration);

  NaluStartModel getNaluStartModel();

  void addPopStateHandler(RouteChangeHandler handler,
                          String contextPath);
  ...
  void addOnHashChangeHandler(RouteChangeHandler handler);
