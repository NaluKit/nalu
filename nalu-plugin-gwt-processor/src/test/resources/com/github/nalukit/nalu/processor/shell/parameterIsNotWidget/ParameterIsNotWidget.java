package com.github.nalukit.nalu.processor.shell.parameterIsNotWidget;
 ...
 */
@Shell("shellName")
public class ParameterIsNotWidget
    extends AbstractShell<MockContext> {

    public ParameterIsNotWidget() {
        super();
    }
    ...
    @Selector("selector01")
    public void setContent(String widget) {
    }
