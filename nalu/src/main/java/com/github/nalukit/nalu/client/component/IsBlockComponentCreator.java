...
/**
 * BlockControllers marked with this interface will create the component instance.
 * This is useful, if you want to use Elemento templating or GWT.create to ensure,
 * replacement rules are used!
 * <br><br>
 * In case using this interface, there must be createBlockComponent method, that looks like that:
 * <code>
 * public IMyComponent createBlockComponent() {
