...
import com.github.mvp4g.nalu.react.application.IsNaluReactLogger;
      ...
      if (element instanceof TypeElement) {
        ...
        if (!this.processorUtils.extendsClassOrInterface(this.processingEnvironment.getTypeUtils(),
                                                         Objects.requireNonNull(loggerElement)
                                                                .asType(),
                                                         this.processingEnvironment.getElementUtils()
                                                                                   .getTypeElement(IsNaluReactLogger.class.getCanonicalName())
                                                                                   .asType())) {
          throw new ProcessorException("@Debug - the logger attribute needs class that extends IsNaluReactLogger");
        }
      } else {
