...
public class DebugTest {
  ...
  public void testDebugAnnotationOnAMethod() {
    Compilation compilation = javac().withProcessors(new NaluReactProcessor())
                                     .compile(new ArrayList<JavaFileObject>() {
                                       {
                                         add(JavaFileObjects.forResource("com/github/mvp4g/nalu/react/processor/eventbus/debugAnnotationOnAMethod/DebugAnnotationOnAMethod.java"));
                                       }
                                     });
  ...
  public void testDebugAnnotationOnAClass() {
    Compilation compilation = javac().withProcessors(new NaluReactProcessor())
                                     .compile(new ArrayList<JavaFileObject>() {
                                       {
                                         add(JavaFileObjects.forResource("com/github/mvp4g/nalu/react/processor/eventbus/debugAnnotationOnAClass/DebugAnnotationOnAClass.java"));
                                       }
                                     });
    CompilationSubject.assertThat(compilation)
                      .failed();
  ...
  public void testDebugAnnotationWithoutExtendsIsEventBus() {
    Compilation compilation = javac().withProcessors(new NaluReactProcessor())
                                     .compile(new ArrayList<JavaFileObject>() {
                                       {
                                         add(JavaFileObjects.forResource("com/github/mvp4g/nalu/react/processor/eventbus/debugAnnotationWithoutExtendsIsEventBus/DebugAnnotationWithoutExtendsIsEventBus.java"));
                                       }
                                     });
    CompilationSubject.assertThat(compilation)
                      .failed();
